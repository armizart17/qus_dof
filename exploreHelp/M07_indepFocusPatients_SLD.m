...
SAM     = load(fullfile(sampleDir,samName+".mat")); % Focus
...
colormap(t1,'gray')
exportgraphics(gcf,fullfile(figsDir,"acs_"+samName+"_rect.png"), ...
   'Resolution','300')
...
for i = 1:length(indices_alpha)
    ...
    % hColor.Label.String = 'dB\cdotcm^{-1}\cdotMHz^{-1}';
    set(gca, 'fontsize', fontSize);
    exportgraphics(gcf,fullfile(figsPolDir,"acs_"+samName+"_pol"+num2str(idx)+".png"), ...
    'Resolution','300')
end
