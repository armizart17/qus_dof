...
% Description:
% Data (Acq in 2024 in LIM, 20 "heallthy" volunteers), reference 544
% Reading Channel Data -> Beamforming -> Spectral Power Law -> RPL-TV
% Saves ROIs (previously generated by inspection)
% Saves MAPS DoFs
% ====================================================================== %

%% 544 specs (Theoretical)
...
% Outcomes directory
% resultsDir  = fullfile(baseDir,'results_LSv2');
% figsDir     = fullfile(baseDir,'figures_LSv2');

resultsDir  = fullfile(baseDir,'results_RPLv2');
figsDir     = fullfile(baseDir,'figures_RPLv2');
