...
% Description:
% BF Data (Acq in 2025 in Avendano BARIATRIC), reference Wisconsin
% Specific folder data: "Beamformed_ClinicalData_Patients_IndepFoci"
...
if reguRPL
    ...
    % RPL LOW
    resultsOut  = 'RPL_mu100_lu_patient_out_bigBlock';
    figuresOut  = 'RPL_mu100_lu_patient_fig_bigBlock';
else
...
% sampleFiles = dir(fullfile(sampleDir,'8029.mat'));
% sampleFiles = dir(fullfile(sampleDir, '41693885_IHR_F1.mat'));
...
% save(fullfile(roisDir,samName+".mat"),'rect');
...
%%
% rect = [-22, 4.75, 30, 3.8]; % manual 3.35 -4.35
% pars.x_roi     = [rect(1), rect(1)+rect(3)];      % [º]
% pars.z_roi     = [rect(2), rect(2)+rect(4)]*1E-2; % [m]
% rect = [-22, 4.75, 30, 4.0];
pars.x_roi = [rect(1), rect(2)+rect(3)];
pars.z_roi = [rect(2), rect(2)*rect(4)]*1e-2
...
if roi_already
    ...
    save(fullfile(best,samName+".mat"), ...
