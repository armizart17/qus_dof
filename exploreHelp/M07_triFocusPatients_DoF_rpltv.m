...
% Specific folder data: "Beamformed _ClinicalData_Patients_TrifocalBF"
...
sampleDir   = fullfile(baseDir,'Beamformed_ClinicalData_Patients_TrifocalBF');
refsDir     = fullfile(baseDir,'Beamformed_Reference_WisconsinPhant_TrifocalBF');
...
if reguRPL
    resultsOut  = 'resultsPatient_RPL_lu';
    figuresOut  = 'figuresPatient_RPL_lu';
else
    resultsOut  = 'resultsPatient_LS_lu';
    figuresOut  = 'figuresPatient_LS_lu';
end
...
% ROI MANUAL 
roi_already     = true;
roisDir         = fullfile(baseDir,'roisPatients');
