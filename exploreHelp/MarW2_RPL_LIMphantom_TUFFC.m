...
% BW = 3.5 - 8.25 MHz, Fc = 5.875 MHz
% wavelength (wl) = 0.262128 mm
% Exec Time: 26.4607 
% -----RPM PowLaw (b.(f.^n))-----
% Δb           = 0.291054
% b_s/b_r [dB] = -5.360264
...
if strcmp(pcname(1:end-1), 'C084285') % PC LIM
    pathData = 'D:\emirandaz\qus\data\SavedDataQUSPhantom\bf';
else % PC EMZ
...
% folderDataSam = '261_nosos'; numPhantomSam = '261';

folderDataRef = '544'; numPhantomRef = '544';
% folderDataRef = '261'; numPhantomRef = '261';
% folderDataRef = '261_nosos'; numPhantomRef = '261';
...
delta_b_prior       = log(db2pow(-5.36)); % from RPM method the best
delta_n_prior       = 0.09; % from RPM method
...
ylim_range = [10^-1 10^0]; % Y-axis limits
