function spectralData = calc_powerSpectra_prox_dis(data, pars)
% function spectralData = calc_powerSpectra_prox_dis(data, pars)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION
% Provides the PowerSpectra for proximal and distal (Sp, Sd) and compensates it accordingly
% -------------------------------------------------------------------------
% INPUTS
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for iRef = 1:nSamples   
        ...
        for jj=1:n
            for ii=1:m
                ...
                % Extra €
                % Sp_full(ii,jj,:,iRef) = tempSp;
                % Sd_full(ii,jj,:,iRef) = tempSd;
                S_full (ii,jj,:,iRef) = 0.5*tempSp + 0.5*tempSd;
    ...
    % spectralData.Spfull            = mean(Sp_full, 4);
    % spectralData.Sdfull            = mean(Sd_full, 4);
