...
if saveOutcomes % (FIGURES & METRICS)
    dirOutcomes = './out/dofJournal/phantomUIUC_samp3_refp2/';
...
%%% \Delta BSC
figure, 
plot(freq_p1, bsc_p1./bsc_p2, 'b--', 'MarkerFaceColor','b','LineWidth', 2, 'DisplayName', 'P1 GT (F.T.)'); % Use regular plot for loglog axes
hold on;
plot(freq_p3, bsc_p3./bsc_p2, 'r--', 'MarkerFaceColor','b','LineWidth', 2, 'DisplayName', 'P3 GT (F.T.)'); % Use regular plot for loglog axes
...
% THEORETICAL
semilogy(freq_p3, bsc_p3./bsc_p2, ':', 'MarkerFaceColor','b','LineWidth', line_width-0.75, 'DisplayName', 'GT (F.T.)'); %
