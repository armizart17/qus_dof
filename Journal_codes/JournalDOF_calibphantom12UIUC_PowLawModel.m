...
% BW = 3 - 8.5 MHz, Fc = 5.75 MHz
% wavelength (wl) = 0.267826 mm
% Exec Time: 35.4676 
% -----RPM PowLaw (b.(f.^n))-----
% Δb           = 0.000701
% b_s/b_r [dB] = -31.544493
% Δn           = 2.174719
% ---------
% -----RPM Gauss (g.exp(-s.f^2))-----
% Δg           = 0.008548
% g_s/g_r [dB] = -20.681150
% Δs           = -0.033982
...
%% LOAD DATA
folderDataSam = 'homoverasonicscalibration'; numPhantomSam = '1'; 
folderDataRef = 'homoverasonicscalibration'; numPhantomRef = '2';
...
switch str2double(numPhantomRef)
    case 1
        alpha_ref   = 0.7; % [dB/cm/MHz]
    case 2
        alpha_ref   = 0.5; % [dB/cm/MHz]

end

delta_alpha_prior   = alpha_sam - alpha_ref; % [dB/cm/MHz]
delta_b_prior       = log(db2pow(-31.544493)); % from RPM method the best
delta_n_prior       = 2.174719; % from RPM method
...
%% PLOT ALL BW (OPTIONAL)

% Saux_sam = calc_powerSpectraFull_prox_dis(SAM, pars)
