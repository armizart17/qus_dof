...
pars.bw          = [3.9 7.6]; % [MHz] 7.75 7.7 7.65 7.6 
pars.overlap     = 0.8;
...
semilogy(freq_p1, bsc_p1./1, ':', 'MarkerFaceColor','b','LineWidth', line_width-0.75, 'DisplayName', 'GT (F.T.)'); %
else
semilogy(freq_p1, bsc_p2./1, ':', 'MarkerFaceColor','b','LineWidth', line_width-0.75, 'DisplayName', 'GT (F.T.)'); %
end 
hold off;
