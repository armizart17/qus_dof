...
% Data Description:
% *** RF data from UIUC acq by SonixOne "SAMp1-REFp2" from 10.1109/TUFFC.2023.3245988
...
%%%%%% MANUAL FIT FROM REFERENCE PHANTOM METHOD P1/P2 %%%%
% -----RPM PowLaw (b.(f.^n))-----
% Δb           = 15.294266
...
if saveOutcomes % (FIGURES & METRICS)
    dirOutcomes = './out/dofJournal/phantomUIUC/';
...
% delta_b_prior       = log(db2pow(15.1)); % from RPM method the best old
% delta_n_prior       = -1.175598; % from RPM method old

delta_b_prior       = log(db2pow(15.5)); % from RPM method the best
delta_n_prior       = -1.275646; % from RPM method
...
% THEORETICAL
semilogy(freq_p1, bsc_p1./bsc_p2, ':', 'MarkerFaceColor','b','LineWidth', line_width-0.75, 'DisplayName', 'GT (F.T.)'); %
