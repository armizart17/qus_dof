...
baseDir = 'Q:\smerino\liver\solo_codigo';
% baseDir = 'LiverAcquisition_24_09_07';

addpath(fullfile(baseDir,'AttenuationUtils'))
addpath(fullfile(baseDir,'UltrasoundUtils'))

sampleDir = fullfile('Q:\smerino\liver','samples');
refsDir = fullfile('Q:\smerino\liver','refs','joined');


resultsDir = fullfile('Q:\smerino\liver','results');
figsDir = fullfile('Q:\smerino\liver','figures');
